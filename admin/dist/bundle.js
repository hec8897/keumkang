...
/* harmony import */ var _glc_nav_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./glc/nav.js */ "./public/component/glc/nav.js");
...
new Vue({
  ...
  components: {
    'component-header': _glc_header_js__WEBPACK_IMPORTED_MODULE_3__["default"],
...
/* harmony import */ var _router_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../router.js */ "./public/component/router.js");
                ...
                .then((result) => {
                    if (result.data.phpResult == 'ok') {
                        ...
                        if (this.FnMode == 'ConsulDel') {
                            ...
                            _eventbus_js__WEBPACK_IMPORTED_MODULE_0__["default"].$emit('Update', {
...
const newsTable = {
    ...
    created() {
        this.getData()
        _glc_eventbus_js__WEBPACK_IMPORTED_MODULE_1__["default"].$on('updateNews', ()=>{
            this.getData()
        })
...
Vue.use(ckeditor4_vue__WEBPACK_IMPORTED_MODULE_4___default.a);
...
const NewsView = {
    ...
    components: {
        ...
        'ckeditor': ckeditor4_vue__WEBPACK_IMPORTED_MODULE_4___default.a.component
    },
    data() {
        return {
            idx: '',
                        ...
                        .then((result) => {
                            if (result.data.phpResult == 'ok') {
                                if (result.data.mode == 'new') {
                                    _glc_eventbus_js__WEBPACK_IMPORTED_MODULE_2__["default"].$emit('updateNews', 'ok')
...
const Spot = {
    ...
    components:{
        'dron-controller':_children_component_dron_js__WEBPACK_IMPORTED_MODULE_0__["default"], //Not used
