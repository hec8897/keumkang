...
/* harmony import */ var _component_spot_photo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./component/spot_photo */ "./js/src/vue/component/spot_photo.js");
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./router */ "./js/src/vue/router.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _eventbus_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./eventbus.js */ "./js/src/vue/component/eventbus.js");
...
/***/ "./js/src/vue/component/news-list-numbering.js":
/*!*****************************************************!*\
  !*** ./js/src/vue/component/news-list-numbering.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/***/ "./js/src/vue/component/news-nav.js":
/*!******************************************!*\
  !*** ./js/src/vue/component/news-nav.js ***!
  \******************************************/
/*! exports provided: default */
...
const NewsNav = {
    ...
    methods: {
        findCate(event, value) {
            ...
            _eventbus_js__WEBPACK_IMPORTED_MODULE_0__["default"].$emit('seachCate', {
                cate: value
            })
...
/* harmony default export */ __webpack_exports__["default"] = (NewsNav);
    ...
    methods: {
        ...
        findTitle(){
            ...
            if(searchTit.value == ""){
                ...
                _eventbus_js__WEBPACK_IMPORTED_MODULE_0__["default"].$emit('seachTitle', {
...
/* harmony default export */ __webpack_exports__["default"] = (NewsSearch);

/***/ }),

/***/ "./js/src/vue/component/news-table.js":
/*!********************************************!*\
  !*** ./js/src/vue/component/news-table.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _news_list_numbering__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./news-list-numbering */ "./js/src/vue/component/news-list-numbering.js");
/* harmony import */ var _eventbus_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./eventbus.js */ "./js/src/vue/component/eventbus.js");
...
const NewsTable = {
    ...
    components: {
        'list-number': _news_list_numbering__WEBPACK_IMPORTED_MODULE_0__["default"]

    },
    created() {
        this.lists = this.propsdatas;

        _eventbus_js__WEBPACK_IMPORTED_MODULE_1__["default"].$on('listUpadate', (Data) => {
            this.lists = Data;

            _eventbus_js__WEBPACK_IMPORTED_MODULE_1__["default"].$emit('UpdateNews', {
                DataLength: Math.ceil((this.lists.length) / 10),
                nowpage: this.limit - 10
            })
        })

        _eventbus_js__WEBPACK_IMPORTED_MODULE_1__["default"].$on('cateChange', (Data) => {
            this.lists = Data
            this.start = 0
            this.limit = 10
            _eventbus_js__WEBPACK_IMPORTED_MODULE_1__["default"].$emit('UpdateNews', {
    ...
    mounted() {
        _eventbus_js__WEBPACK_IMPORTED_MODULE_1__["default"].$on('NextPage', (Data) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _list_numbering__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list-numbering */ "./js/src/vue/component/list-numbering.js");
/* harmony import */ var _eventbus_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./eventbus.js */ "./js/src/vue/component/eventbus.js");
...
/* harmony default export */ __webpack_exports__["default"] = (SpotPhoto);



/***/ }),

/***/ "./js/src/vue/news-table-main.js":
/*!***************************************!*\
  !*** ./js/src/vue/news-table-main.js ***!
  \***************************************/
/*! exports provided: default */
...
/* harmony import */ var _component_news_table__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/news-table */ "./js/src/vue/component/news-table.js");
/* harmony import */ var _component_eventbus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/eventbus */ "./js/src/vue/component/eventbus.js");
...
const newsTableMain = {
  ...
  components: {
    ...
    'news-table': _component_news_table__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  created() {
    ...
    getdata(Data) {
      ...
      axios.post(`${baseURI}`, {
        ...
        .then((result) => {
          ...
          this.results = this.lists;
          _component_eventbus__WEBPACK_IMPORTED_MODULE_3__["default"].$emit('listUpadate', this.lists)
        })
        .catch(err => console.log('Login: ', err));
...
/* harmony default export */ __webpack_exports__["default"] = (newsTableMain);

/***/ }),

/***/ "./js/src/vue/news-view.js":
/*!*********************************!*\
  !*** ./js/src/vue/news-view.js ***!
  \*********************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (newsViewMain);

/***/ }),

/***/ "./js/src/vue/router.js":
/*!******************************!*\
  !*** ./js/src/vue/router.js ***!
  \******************************/
/*! exports provided: default */
...
/* harmony import */ var _news_table_main__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./news-table-main */ "./js/src/vue/news-table-main.js");
/* harmony import */ var _news_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./news-view */ "./js/src/vue/news-view.js");
  ...
  routes: [
      {
          path:'/',
          name:'new-table',
          component:_news_table_main__WEBPACK_IMPORTED_MODULE_1__["default"]
      },
      {
        path:'/newstb/:cate',
        props:true,
    ...
    },
      {
          ...
          props:true,
          name:'news-view',
          component:_news_view__WEBPACK_IMPORTED_MODULE_2__["default"]
      }
    ]
})
