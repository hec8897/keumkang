...
/* harmony import */ var _component_news_search__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/news-search */ "./js/src/vue/component/news-search.js");
/* harmony import */ var _component_news_nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/news-nav */ "./js/src/vue/component/news-nav.js");
/* harmony import */ var _component_news_table__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component/news-table */ "./js/src/vue/component/news-table.js");
/* harmony import */ var _component_eventbus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component/eventbus */ "./js/src/vue/component/eventbus.js");
...
new Vue({
  ...
  components: {
    'news-search': _component_news_search__WEBPACK_IMPORTED_MODULE_2__["default"],
    'news-nav': _component_news_nav__WEBPACK_IMPORTED_MODULE_3__["default"],
    'news-table': _component_news_table__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  created(){
    ...
    _component_eventbus__WEBPACK_IMPORTED_MODULE_5__["default"].$emit('listUpadate',this.lists)
   
})
.catch(err => console.log('Login: ', err));
    _component_eventbus__WEBPACK_IMPORTED_MODULE_5__["default"].$on('seachCate',(Data)=>{
      if(Data.cate =='all'){
        this. results = this.lists;
      }
      else{
    ...
    _component_eventbus__WEBPACK_IMPORTED_MODULE_5__["default"].$emit('cateChange',this.results)

    })
    _component_eventbus__WEBPACK_IMPORTED_MODULE_5__["default"].$on('seachTitle',(Data)=>{
      console.log(Data)
    })
